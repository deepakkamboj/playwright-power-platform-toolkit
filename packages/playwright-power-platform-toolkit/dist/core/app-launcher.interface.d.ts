...
export interface IAppLauncher {
     ...
     */
    launchByName(appName: string, findAppCallback: (appName: string) => Promise<Locator>, mode: AppLaunchMode, options?: AppPlayerOptions): Promise<void>;
    /**
     * Launch app by ID
     ...
     * @param options - Additional launch options
     */
    launchById(appId: string, baseUrl: string, mode: AppLaunchMode, options?: AppPlayerOptions): Promise<void>;
    /**
     ...
     * @param assertOptions - Assertion options
     */
    assertControlText(options: ControlOptions, expectedText: string, assertOptions?: AssertionOptions): Promise<void>;
    /**
     * Close the app
     */
