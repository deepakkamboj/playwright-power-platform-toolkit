...
exports.getModelDrivenNavItem = exports.getModelDrivenFormField = exports.getModelDrivenTablePage = exports.getModelDrivenDataAutomationId = exports.ModelDrivenAppLocators = void 0;
exports.ModelDrivenAppLocators = {
    ...
    Home: {
        ...
        AppCard: (appName) => `[role="gridcell"]:has-text("${appName}")`,
    ...
    Designer: {
        ...
        Pages: {
            ...
            // Page Items
            PageItem: (pageName) => `[role="treeitem"]:has-text("${pageName}")`,
        ...
        Navigation: {
            ...
            // Navigation Items
            GroupItem: (groupName) => `[role="treeitem"][aria-label="${groupName}"]`,
            SubAreaItem: (subAreaName) => `[role="treeitem"]:has-text("${subAreaName}")`,
            // Properties
        ...
        Data: {
            ...
            TableItem: (tableName) => `[role="listitem"]:has-text("${tableName}")`,
    ...
    AddPageDialog: {
        ...
        TableOption: (tableName) => `option:has-text("${tableName}")`,
        // Forms
        FormsList: '[role="list"][aria-label="Forms"]',
        FormItem: (formName) => `[role="listitem"]:has-text("${formName}")`,
        ...
        ViewItem: (viewName) => `[role="listitem"]:has-text("${viewName}")`,
    ...
    Runtime: {
        ...
        SiteMap: {
            ...
            GroupHeader: (groupName) => `button[aria-label="${groupName}"]`,
            SubArea: (subAreaName) => `a[aria-label="${subAreaName}"]`,
        ...
        Content: {
            ...
            FormTab: (tabName) => `[role="tab"][aria-label="${tabName}"]`,
            FormSection: (sectionName) => `[data-section-name="${sectionName}"]`,
            FormField: (fieldName) => `[data-field-name="${fieldName}"]`,
            // Dashboard View
    ...
    Solutions: {
        ...
        SolutionOption: (solutionName) => `option:has-text("${solutionName}")`,
        AddButton: 'button[aria-label="Add"]',
    },
    // Delete Confirmation
    DeleteDialog: {
 ...
 */
const getModelDrivenDataAutomationId = (automationId) => {
    return `[data-automation-id="${automationId}"]`;
};
exports.getModelDrivenDataAutomationId = getModelDrivenDataAutomationId;
/**
 * Helper function to get table page selector
 */
const getModelDrivenTablePage = (tableName) => {
    return `[data-table-name="${tableName}"]`;
};
exports.getModelDrivenTablePage = getModelDrivenTablePage;
/**
 * Helper function to get form field selector
 */
const getModelDrivenFormField = (fieldName) => {
    return `[data-field-name="${fieldName}"]`;
};
exports.getModelDrivenFormField = getModelDrivenFormField;
/**
 * Helper function to get navigation item selector
 */
const getModelDrivenNavItem = (itemName) => {
    return `a[aria-label="${itemName}"]`;
};
exports.getModelDrivenNavItem = getModelDrivenNavItem;
