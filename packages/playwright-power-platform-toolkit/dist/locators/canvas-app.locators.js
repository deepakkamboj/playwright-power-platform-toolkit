...
exports.getCanvasScreenByName = exports.getCanvasControlByName = exports.getCanvasDataTestId = exports.CanvasAppLocators = void 0;
exports.CanvasAppLocators = {
    ...
    Studio: {
        ...
        Data: {
            ...
            DataSourceItem: (sourceName) => `[role="listitem"]:has-text("${sourceName}")`,
        ...
        Canvas: {
            ...
            Screen: (screenName) => `[data-control-name="${screenName}"]`,
            Control: (controlName) => `[data-control-name="${controlName}"]`,
        ...
        Properties: {
            ...
            PropertyItem: (propertyName) => `[data-property-name="${propertyName}"]`,
            // Common Properties
        ...
        Screens: {
            ...
            ScreenItem: (screenName) => `[role="treeitem"]:has-text("${screenName}")`,
    ...
    Details: {
        ...
        VersionItem: (version) => `[role="listitem"]:has-text("Version ${version}")`,
 ...
 */
const getCanvasDataTestId = (testId) => {
    return `[data-testid="${testId}"]`;
};
exports.getCanvasDataTestId = getCanvasDataTestId;
/**
 * Helper function to get control by name
 */
const getCanvasControlByName = (controlName) => {
    return `[data-control-name="${controlName}"]`;
};
exports.getCanvasControlByName = getCanvasControlByName;
/**
 * Helper function to get screen by name
 */
const getCanvasScreenByName = (screenName) => {
    return `[data-screen-name="${screenName}"]`;
};
exports.getCanvasScreenByName = getCanvasScreenByName;
