 ...
 * ```
 */
export declare function extractTokenFromStorage(apiUrl?: string): string;
/**
 ...
 * ```
 */
export declare function createAuthenticatedApiContext(token: string, baseUrl?: string): Promise<import("@playwright/test").APIRequestContext>;
/**
 ...
 * ```
 */
export declare function buildBapApiEndpoint(pathQuery: string): string;
/**
 ...
 * ```
 */
export declare function createBapApiHeaders(pathQuery: string, token: string): {
    authorization: string;
    'x-ms-user-agent': string;
    'x-ms-path-query': string;
    accept: string;
};
/**
 ...
 * ```
 */
export declare function buildResourceQueryEndpoint(): string;
/**
 ...
 * ```
 */
export declare function createQueryPayload(options?: QueryOptions): {
    query: {
        skip: number;
        top: number;
        filter: string;
 ...
 * ```
 */
export declare function extractRequestId(headers: {
    [key: string]: string;
}): string | undefined;
/**
 ...
 * ```
 */
export declare function validateApiResponse(response: any): Promise<ApiResponseValidation>;
/**
 ...
 * ```
 */
export declare function pollOperationStatus(operationUrl: string, token: string, maxAttempts?: number, intervalMs?: number): Promise<OperationResult>;
