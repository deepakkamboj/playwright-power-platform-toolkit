...
This guide explains how to use the **formContext** helpers in Playwright Power Platform Toolkit to interact with Model-Driven App forms programmatically.
...
The formContext helpers are included in the Playwright Power Platform Toolkit:
