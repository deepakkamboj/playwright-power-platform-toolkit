...
[Playwright Power Platform Toolkit](../README.md) / BaseLocators
...
`"dialog"` | `"button"` | `"link"` | `"textbox"` | `"heading"` | `"menuitem"` | `"grid"` | `"row"` | `"cell"` | `"navigation"` | `"searchbox"` | `"switch"` | `"rowheader"` | `"gridcell"` | `"menubar"` | `"checkbox"` | `"radio"` | `"combobox"` | `"listbox"` | `"option"` | `"tab"` | `"tabpanel"`
