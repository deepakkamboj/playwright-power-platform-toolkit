...
test.describe.serial('Canvas App Examples', () => {
  ...
  integrationTest(
    ...
    Team.Shell,
    'Example: Create blank Canvas app',
    async ({ page }) => {
  ...
  integrationTest(
    ...
    Team.Shell,
    'Example: Create Canvas app with controls',
    async ({ page }) => {
      const canvasApp = new CanvasAppPage(page);
  ...
  integrationTest(
    ...
    Team.Shell,
    'Example: Create Canvas app with multiple screens',
    async ({ page }) => {
      const canvasApp = new CanvasAppPage(page);
  ...
  integrationTest(
    ...
    Team.Shell,
    'Example: Create Canvas app with data source',
    async ({ page }) => {
      const canvasApp = new CanvasAppPage(page);
  ...
  integrationTest(
    ...
    Team.Shell,
    'Example: Test Canvas app in play mode',
    async ({ page }) => {
      const canvasApp = new CanvasAppPage(page);
