...
test.describe.serial('Model Driven App Examples', () => {
   ...
   */
  test.skip('Example: Create blank Model Driven app', async ({ page }) => {
   ...
   */
  test.skip('Example: Create Model Driven app with table pages', async ({ page }) => {
    const modelApp = new ModelDrivenAppPage(page);
   ...
   */
  test.skip('Example: Create Model Driven app with navigation', async ({ page }) => {
    const modelApp = new ModelDrivenAppPage(page);
   ...
   */
  test.skip('Example: Configure Model Driven app settings', async ({ page }) => {
    const modelApp = new ModelDrivenAppPage(page);
   ...
   */
  test.skip('Example: Validate Model Driven app configuration', async ({ page }) => {
    const modelApp = new ModelDrivenAppPage(page);
   ...
   */
  test.skip('Example: Test Model Driven app in runtime', async ({ page }) => {
    const modelApp = new ModelDrivenAppPage(page);
   ...
   */
  test.skip('Example: Share Model Driven app', async ({ page }) => {
    const modelApp = new ModelDrivenAppPage(page);
