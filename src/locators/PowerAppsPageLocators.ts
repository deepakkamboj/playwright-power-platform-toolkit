 ...
 * Centralized locator management for Power Apps and Power Platform
 * Supports Canvas Apps, Model-Driven Apps, and other Power Platform applications
 */

import { Page, Locator } from '@playwright/test';
import { LocatorUtils } from './BaseLocators';

/**
 * Power Apps Page Selectors - Constant object for easy management
 * Organized by page/section for better maintainability
 * Works with Canvas Apps, Model-Driven Apps, and Power Platform portal
 */
export const PowerAppsPageSelectors = {
  ...
  // ============ Upload Image Page ============
  UploadAnImagePage: {
    NameTextBox: '(//label[text()="Name"]/following::input)[1]',
  },

  // ============ Draw Tags Page ============
  DrawTagsAndAssignComponentsPage: {
    PageHeader: '#pagePanels-layer-id',
    PageFooter: '//div[contains(@class, "baf-multistep__footer")]',
    NextButton: '//span[text()="Next"]',
  },

  // ============ Setup Data Page ============
  SetupYourDataPage: {
    ChoiceGroup: '//div[contains(@class, "ms-ChoiceFieldGroup-flexContainer")]',
    SkipForNowRadio: '//span[text()="Skip this for now"]',
